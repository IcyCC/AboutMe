...
\begin{itemize}[parsep=0.5ex]
    \item 熟练掌握 Python, 作为主力语言开发多个商业项目, 并对其虚拟机有一点了解, 有其 C/C++ 拓展开发经验
    \item 较为熟悉 C++, 了解 C++ 的新特性并在个人项目中实践
    \item 拥有全栈开发和架构设计能力,熟悉Python和Go的 web 开发和vue前端, 主导开发过5+个商业项目
    \item 有并发网络编程经验, 熟悉 Reactor模型, 了解过多个网络库的设计并在 unix 下实现过网络库
...
\role{Golang, Gin, ELectron, libffi}{商业项目}
\begin{onehalfspacing}
