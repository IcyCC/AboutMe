...
\textit{在读本科生}\ \quad  网络工程专业, 预计 2020 年 7 月毕业 
...
\begin{itemize}[parsep=0.5ex]
  \item 丰富的 Python 开发经验, 作为主力语言开发多个商业项目, 有其 \textbf{C/C++ 混合}开发经验并了解 \textbf{协程}
    \item 较熟悉 C++, 了解 \textbf{C11} 值语义, 内存管理, 并发等新特性并在个人项目中实践.
    \item 拥有\textbf{全栈开发}和架构设计能力,熟悉Python和Golang的 web 开发和vue前端, 主导开发过\textbf{5+}较大商业项目
    \item 有并发网络编程经验, 熟悉 Reactor模型, 了解muduo等网络库的设计并在 unix 下实现过网络库
...
\textbf{项目介绍}：\c 为学习C++网络编程,所编写的一个 Reactor 模式的并发网络库,基于Poll做io复用, 支持各种定时任务, 基于 SafeQueue 做多线程的同步,提供客户端链接和服务器的封装, 加入了一些自己的想法
\end{onehalfspacing}
